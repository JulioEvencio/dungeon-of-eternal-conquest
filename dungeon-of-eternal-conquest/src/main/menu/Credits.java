...
public class Credits {
	...
	public void render(Graphics graphics) {
		...
		graphics.drawString("Press SPACE to go back to main menu", Game.WIDTH * Game.SCALE / 2 - 230, 410);
	}
	...
	public void renderFullscreen(Graphics graphics, int width, int height) {
		...
		graphics.drawString("Press SPACE to go back to main menu", width / 2 - 250, height / 2 + 210);
	}
